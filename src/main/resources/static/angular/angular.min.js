...
var systemError = function () {
    layer.msg('未知错误，请联开发者');
}

var requestError = function (msg) {
    layer.msg('请求失败:'+msg,{icon:5})
}
...
var deleteSuccess = function (msg) {
    if(msg!=null){
        layer.msg('删除成功！:'+msg,{icon:1});
    }else{
        layer.msg('删除成功！',{icon:1});
    }

}
var primaryMessage = function (msg) {
    layer.msg(msg);
}
//获取当前时间，格式YYYY-MM-DD
